...
class DSPipeline():
    ...
    def __init__(self,
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("./bloom-3b-tokenizer")
        ...
        if (is_meta):
            ...
            self.model = AutoModelForCausalLM.from_pretrained("./bloom-3b", trust_remote_code=trust_remote_code, ignore_mismatched_sizes=True)
...
class Performance():
    ...
    def print_perf_stats(latency_set, config, dtype, batch_size, warmup=3):
        ...
        print(f"latency_set1: {latency_set}")
        latency_set = latency_set[warmup:]
        print(f"latency_set2: {latency_set}")
